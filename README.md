...
## Example of usage
First create a [Nutshell **APIKEY**](http://www.import2.com/questions/235-how-do-i-get-nutshell-crm-api-key). Then Use the e-mail address one of your existing users as the **USERNAME**. Note that nutshell allows one users to have multiple e-mail addresses. The API requires that you use the **primary** one.
